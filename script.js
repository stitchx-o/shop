...
const statesList = [
    "Adrar", "Chlef", "Laghouat", "Oum El Bouaghi", "Batna", "Béjaïا", "Biskra", "Bechar", 
    ...
    "Bordj Bou Arreridj", "Boumerدès", "El Tarf", "Tindouf", "Tissemsilt", "El Oued", 
    "Khenchela", "Souk Ahras", "Tipaza", "Mila", "Aïn Defla", "Naâma", "Aïn Témouchent", 
    "Ghardaïa", "Relizane", "Timimoun", "Bordj Badji Mokhtar", "Ouled Djellal", "Béni Abbès", 
    "In Salah", "In Guezzam", "Touggourt", "Djanet", "El M'Ghair", "El Meniaa", "Boumerdès"
];
...
const communesData = {
    ...
    "Chlef": ["Chlef", "Tenes", "Benairia", "El Karimia", "Tadjena", "Taougrite", "Beni Haoua", "Sobha", "Harchoun", "Ouled Fares", "Sidi Akkacha", "Boukadir", "Beni Rached", "Talassa", "Heraren", "Oued Goussine", "Dahra", "Ouled Abbes", "Sendjas", "Sidi Abderrahmane", "Oued Fodda", "Ouled Ben Abdelkader", "Bouzghaia", "Ain Merane", "Oum Drou", "Breira", "Moussadek", "El Hadjadj", "Labiod Medjadja", "Oued Sly", "Sidi Abderrahmane", "Medjadja"],
    ...
    "Oum El Bouaghi": ["Oum El Bouaghi", "Ain Beida", "Ain M'lila", "Behir Chergui", "El Amiria", "Sigus", "El Belala", "Ain Babouche", "Berriche", "Ouled Hamla", "Dhalâa", "Ain Kercha", "Hanchir Toumgani", "Fkirina", "Oued Nini", "Meskiana", "Dhir", "Ain Fekroun", "Rahia", "Ain Zitoun", "Ouled Gacem", "Ouled Zouai", "Souk Naamane", "Zorg"],
    ...
    "Béjaïa": ["Béjaïa", "Amizour", "Feraoun", "Taourirt Ighil", "Chellata", "Tamokra", "Timzrit", "Souk El Tenine", "Melbou", "Oued Ghir", "Tala Hamza", "Barbacha", "Beni Djellil", "Beni Maouche", "Sidi Ayad", "Smaoun", "Kendira", "Tifra", "Sidi Aich", "Leflaye", "Akbou", "Ouzellaguen", "Ighram", "Chemini", "Souamar", "Toudja", "Kherrata", "Draâ El Kaïd", "Beni Ksila", "Beni Mallikeche", "Boudjellil", "Adekar", "Akfadou", "Tinebdar", "El Kseur", "Fenaia Ilmaten"],
    ...
    "Bechar": ["Béchar", "Abadla", "Taghit", "El Ouata", "Beni Abbes", "Kerzaz", "Igli", "Tabelbala", "Ouled Khoudir", "Lahmar", "Mougheul", "Kenadsa", "Meridja", "Timoudi", "Beni Ikhlef", "Ksabi", "Mechraa Houari Boumediene", "Beni Ounif"],
    "Blida": ["Blida", "Chebli", "Bouinan", "Oued El Alleug", "Ouled Yaich", "Chrea", "El Affroun", "Mouzaia", "Hammam Melouane", "Bougara", "Souhane", "Larbaa", "Soumaa", "Guerrouaou", "Boufarik", "Meftah", "Benkhelil", "Beni Mered", "Ouled Slama", "Mouzai", "Sidi Moussa"],
    ...
    "Tébessa": ["Tébessa", "Bir El Ater", "Cheria", "Stah Guentis", "El Hammamet", "Safsaf El Ouesra", "Bedjene", "Ouenza", "El Meridj", "Ain Zerga", "Morsott", "Bir Dheb", "El Ogla", "Bir Mokkadem", "Guorriguer", "Bekkaria", "Boukhadra", "El Kouif", "M'douhal", "Negrine", "Ferkane", "El Mezeraa", "Boulhaf Dir"],
    "Tlemcen": ["Tlemcen", "Beni Mester", "Ain Tallout", "Remchi", "El Feuilla", "Sabra", "Ghazaouet", "Souani", "Djebala", "El Aricha", "Beni Snous", "Bensekrane", "Fellaoucene", "Azails", "Maghnia", "Hammam Boughrara", "Zenata", "Souahlía", "Nedroma", "Sidi Djillali", "Beni Bahdel", "Beni Ouarsous", "Honaine", "Sidi Medjahed", "Amieur", "Aïn Fezza", "Hennaya", "Chetouane", "Mansourah", "Beni Khellad", "Souk Thleta", "Terny Beni Hediel"],
    "Tiaret": ["Tiaret", "Medroussa", "Oued Lilli", "Sidi Hosni", "Ain El Hadid", "Mechraa Safa", "Hamadia", "Bougara", "Rechaiga", "Tidda", "Naima", "Meghila", "Guertoufa", "Sidi Bakhti", "Sidi Ali Mellal", "Ain Deheb", "Chehaima", "Sidi Abderrahmane", "Zmalet El Emir Abdelkader", "Madna", "Ksar Chellala", "Serghine", "Mahdia", "Ain Zarit", "Sebaine", "Faidja", "Si Abdelghani", "Sougueur", "Tousnina", "Meghila", "Dahmouni", "Rahouia"],
    "Tizi Ouzou": ["Tizi Ouzou", "Ain El Hammam", "Akbil", "Abi Youcef", "Ait Yahia", "Iferhounene", "Bouzeguene", "Azazga", "Illoula Oumalou", "Yakouren", "Larbaa Nath Irathen", "Tizi Rached", "Irdjen", "Azeffoun", "Iflissen", "Tigzirt", "Ait Aissa Mimoun", "Ouaguenoun", "Timizart", "Maatkas", "Souk El Tenine", "Draâ Ben Khedda", "Tizi Gheniff", "Ait Yahia Moussa", "Draâ El Mizan", "Frikat", "Ait Kouffi", "Mekla", "Ait Khellili", "Souamaâ", "Beni Yenni", "Iboudraren", "Ouacif", "Ait Toudert", "Ait Boumahdi", "Beni Douala", "Beni Aissa", "Beni Zmenzer", "Idjeur", "Ait Aggouacha", "Imsouhal", "Ait Oumalou", "Ait Bouaddou", "Illilten", "Zekri", "Yakouren", "Mizrana", "Tizi N'Tléta"],
    ...
    "Sidi Bel Abbès": ["Sidi Bel Abbès", "Tessala", "Sidi Brahim", "Mostefa Ben Brahim", "Telagh", "Mezaourou", "Dhaya", "Ain El Berد", "Sidi Ali Benyoub", "Sidi Yacoub", "Sidi Lahcene", "Lamtar", "Sidi Khaled", "Boukhanafis", "Tabia", "Badredine El Mokrani", "Sehala Thaoura", "Tilmouni", "Sidi Hamadouche", "Sidi Chaib", "Makedra", "Ain Thrid", "Sehailia", "Tenira", "Benachiba Chelia", "Zerouala", "Merine", "Oued Taourira", "Teghalimet", "Belarbi", "Sfisef", "M'id", "Boudjebaa El Bordj", "Ain Adden", "Sidi Daho des Zairs", "Amarnas", "Hassi Zahana", "Hassi Dahou", "Oued Sefioun"],
    "Guelma": ["Guelma", "Nechmaya", "Bouati Mahmoud", "Oued Zenati", "Tamlouka", "Ras El Agba", "Ain Makhlouf", "Ain Larbi", "Ain Sandel", "Bou Hachana", "Medjez Sfa", "Bouchegouf", "Mashroha", "Ain Ben Beida", "Guelaat Bou Sbaa", "Boumahra Ahmed", "Hammam Debagh", "Roknia", "Dahouara", "Hammam N'Bail", "Belkheir", "Beni Mezline", "Medjez Amar", "Houari Boumédiène"],
    ...
    "Médéa": ["Médéa", "Ouzera", "Tamesguida", "Ouled Hellal", "Sidi Naamane", "Khams Djouamaa", "Derrag", "Chahbounia", "Boughezoul", "El Ouardania", "Hannacha", "Ouled Bouachra", "Sedraya", "Seghouane", "Mezerana", "Ouled Maaref", "Ain Boucif", "Kef Lakhdar", "Sidi Damed", "Souagui", "Ksar El Boukhari", "Moudjbar", "Ouled Antar", "Djouab", "Sidi Zahar", "Sidi Ziane", "El Azizia", "Mghane", "Bir Ben Laabed", "Baata", "Sidi Rebia", "Beni Slimane", "Bouskene", "Ouled Brahim", "Tablat", "El Omaria", "Ouled Deide", "Damiat", "Oum El Djalil", "Aziz", "Saneg", "Tlatet Douair", "Zoubiria", "Si Mahdjoub", "Bouaiche", "Ouedane", "Berrouaghia", "Rebaia", "El Hamdania", "Oued Harbil"],
    "Mostaganem": ["Mostaganem", "Sayada", "Mesra", "Bouguirat", "Sirat", "Ain Sidi Cherif", "Mansourah", "Hassi Maameche", "Mazagran", "Stidia", "Foronaka", "Ain Nouissy", "Hacine", "Sour", "Oued El Kheir", "Sidi Ali", "Ouled Maallah", "Tazgait", "Sidi Lakhdar", "Hadadj", "Abdelmalek Ramdane", "Khadra", "Achaacha", "Ouled Boughalem", "Nekmaria", "Safsaf", "Benabdelmalek Ramdane", "Souaflia", "Bouguirat"],
    ...
    "Bordj Bou Arreridj": ["Bordj Bou Arreridj", "Ras El Oued", "Bordj Zemoura", "Mansoura", "El M'hir", "Ben Daoud", "El Ach", "Ghilassa", "Taglait", "Bordj Ghedir", "Belimour", "Ouled Brahem", "Bir Kasdali", "Khelil", "Sidi Embarek", "Tixter", "Hamadia", "El Anasser", "Tesmart", "Medjana", "Teniet En Nasr", "Hasnaoua", "Ouled Dahmane", "Yeryas", "Ben Daoud", "El Main", "Djaafra", "Colla"],
    "Boumerdès": ["Boumerdès", "Boudouaou", "Afir", "Bordj Menaiel", "Baghlia", "Sidi Daoud", "Naciria", "Isser", "Zemmouri", "Si Mustapha", "Tidjelabine", "Chabet El Ameur", "Thenia", "Souk El Had", "Ouled Moussa", "Larbatache", "Khemis El Khechna", "Hamadi", "Boudouaou El Bahri", "Taourga", "Ouled Haddadj", "Leghata", "Djinet", "Kharrouba", "Bouzegza Keddara"],
    "El Tarf": ["El Tarf", "Bouhadjar", "Ben M'hidi", "Besbes", "Drean", "El Kala", "Asfour", "Berrihane", "Chebaita Mokhtar", "Chefia", "Chihani", "Ain El Assel", "Bougous", "Echatt", "Oued Zitoun", "Ramloul", "Souarekh", "Zerizer", "Hammâm Beni Salah", "Zitouna"],
    ...
    "El Oued": ["El Oued", "Robbah", "Bayadha", "Nakhla", "Guemar", "Ourmas", "Taghzout", "Hamraia", "Reguiba", "Debila", "Hassani Abdelkrim", "Hassi Khalifa", "Magrane", "Sidi Aoun", "Mih Ouansa", "Kouinine", "Sidi Amrane", "Mrara", "Djamaa", "Tenedla", "El M'ghair", "Oum Touyour", "Sidi Khelil", "Still", "Bordj Omar Driss", "Ben Guecha", "Douar El Ma"],
    "Khenchela": ["Khenchela", "Babar", "El Hamma", "Baghai", "El Mahmal", "Ouled Rechache", "Chechar", "Khirane", "Yabous", "Taouzient", "Bouhmama", "Remila", "Kais", "Ensigha", "M'Sara", "Chelaghm El Aid", "Tamza", "Ain Touila"],
    "Souk Ahras": ["Souk Ahras", "Sedrata", "Hanancha", "Machroha", "Ouled Driss", "Sidi Fredj", "Bir Bouhouche", "Safsaf El Ouesra", "Ragouba", "Drea", "Taoura", "Zaarouria", "Ouled Moumen", "Merahna", "Haddada", "Khedara", "M'daourouch", "Tiffech", "Ragouba", "Ouled Driss", "Ain Soltane", "Quillen", "Sidi Fredj", "Terrag"],
    "Tipaza": ["Tipaza", "Menaceur", "Larhat", "Douaouda", "Bourkika", "Khemisti", "Ahmer El Ain", "Nadhor", "Hadjوت", "Sidi Amar", "Sidi Ghiles", "Cherchell", "Damous", "Gouraya", "Sidi Semiane", "Meskelmoun", "Hadjret Ennous", "Sidi Rached", "Attatba", "Chaiba", "Bou Ismail", "Fouka", "Bouharoun", "Aine Tagourait", "Koléa"],
    "Mila": ["Mila", "Oued Endja", "Ahmed Rachedi", "Bouhatem", "Rouached", "Tergou", "Grarem Gouga", "Hamala", "Sidi Khelifa", "Chigara", "Sidi Merouane", "Teleghma", "Oued Seguen", "Oued Athmania", "Aïn Mellouk", "Chelghoum Laid", "Tadjenanet", "Benyahia Abderrahmane", "Taya", "Minar Zarza", "Amira Arrès", "Ferdjioua", "Derradji Bousselah", "Tibane", "Baala", "Zeghaia"],
    "Aïn Defla": ["Aïn Defla", "Miliana", "Boumedfaâ", "Khemis Miliana", "Hammam Righa", "Sidi Lakhdar", "Aïn Benian", "Vesoul Benian", "Hocinia", "Djelida", "Bourached", "Hoceinia", "Djemâa Ouled Cheikh", "El Amra", "Mekhatria", "El Abadia", "Tacheta Zougagha", "Bir Ould Khelifa", "Bordj Emir Khaled", "Tarik Ibn Ziad", "Bathia", "Belaas", "Hassasna", "Djendel", "Main", "Djouab", "El Attaf"],
    "Naâma": ["Naâma", "Mecheria", "Ain Sefra", "Tiout", "Sfissifa", "Moghrar", "Asla", "Djeniane Bourzeg", "Kasdir", "Makman Ben Amer", "El Biodh"],
    "Aïn Témouchent": ["Aïn Témouchent", "Sidi Ben Adda", "Maleh", "Chaabet El Ham", "Terga", "El Amria", "Hassi El Ghella", "Ouled Boudjemaa", "Aghlal", "Ain Kihal", "Aïn Tolba", "Hamman Bouhadjar", "Chentouf", "Sidi Boumediene", "Oued Berkeche", "Sidi Safi", "Beni Saf", "Emir Abdelkader", "Oulhaça Gheraba", "Sidi Ouriache", "Bouzedjar", "Hammam Bouhadjar", "Sidi Ben Adda"],
    "Ghardaïa": ["Ghardaïa", "El Atteuf", "Bounoura", "Metlili", "Zelfana", "Dhayet Bendhahoua", "Berriane", "Guerrara", "El Meniaa", "Hassi Fehal", "Hassi Gara", "Sebseb"],
    "Relizane": ["Relizane", "Oued Rhiou", "Bendaoud", "Zemmora", "Dar Ben Abdellah", "Djidiouia", "Hamri", "El Guettar", "Sidi M'hamed Benaouda", "Ain El Tarik", "Had Echkalla", "El Matmar", "Sidi Khettab", "Ammi Moussa", "Oued El Djemaa", "Mendes", "Sidi Lazreg", "Ouarizane", "Mazouna", "El Hassi", "Sidi M'hamed Ben Ali", "Beni Zentis", "Medjabaa", "Lahlef", "Souk El Haad", "Beni Zentis"]
};

const deliveryData = {
    'Alger': { home: 400, office: 400 }, 'Tipaza': { home: 600, office: 400 },
    'Boumerdès': { home: 600, office: 400 }, 'Blida': { home: 600, office: 400 },
    'Relizane': { home: 700, office: 400 }, 'Aïn Témouchent': { home: 700, office: 400 },
    'Aïn Defla': { home: 700, office: 400 }, 'Mila': { home: 700, office: 400 },
    ...
    'Mostaganem': { home: 700, office: 400 }, 'Médéa': { home: 700, office: 400 },
    'Constantine': { home: 700, office: 400 }, 'Guelma': { home: 700, office: 400 },
    'Annaba': { home: 700, office: 400 }, 'Sidi Bel Abbès': { home: 700, office: 400 },
    'Skikda': { home: 700, office: 400 }, 'Saïda': { home: 700, office: 400 },
    'Sétif': { home: 700, office: 400 }, 'Jijel': { home: 700, office: 400 },
    'Tizi Ouzou': { home: 700, office: 400 }, 'Tiaret': { home: 700, office: 400 },
    'Tlemcen': { home: 700, office: 400 }, 'Bouira': { home: 700, office: 400 },
    'Béjaïa': { home: 700, office: 400 }, 'Batna': { home: 700, office: 400 },
    'Oum El Bouaghi': { home: 700, office: 400 }, 'Chlef': { home: 700, office: 400 },
    'Ghardaïa': { home: 850, office: 550 }, 'El Oued': { home: 850, office: 550 },
    'Ouargla': { home: 850, office: 550 }, 'Djelfa': { home: 850, office: 550 },
    'Tébessa': { home: 850, office: 550 }, 'Biskra': { home: 850, office: 550 },
    'Laghouat': { home: 850, office: 550 }, 'Ouled Djellal': { home: 900, office: 500 },
    'Touggourt': { home: 900, office: 500 }, "El M'Ghair": { home: 900, office: 500 },
    'El Meniaa': { home: 900, office: 500 }, 'Timimoun': { home: 1300, office: 850 },
    'Bordj Badji Mokhtar': { home: 1300, office: 850 }, 'Béni Abbès': { home: 1300, office: 850 },
    'Naâma': { home: 1350, office: 900 }, 'El Bayadh': { home: 1350, office: 900 },
    'Béchar': { home: 1350, office: 900 }, 'Adrar': { home: 1350, office: 900 },
    'In Salah': { home: 1500, office: 1250 }, 'In Guezzam': { home: 1500, office: 1250 },
    'Djanet': { home: 1500, office: 1250 }, 'Tindouf': { home: 1550, office: 1300 },
    'Illizi': { home: 1550, office: 1300 }, 'Tamanrasset': { home: 1550, office: 1300 }
};
...
// التبديل بين الكارت والتفاصيل
document.getElementById('productCard').onclick = () => {
    document.getElementById('productCard').style.display = 'none';
    document.getElementById('orderDetails').style.display = 'flex';
    setTimeout(() => document.getElementById('orderDetails').style.opacity = '1', 50);
};
...
// تحديث البلديات والسعر عند تغيير الولاية
stateInput.onchange = () => {
...
[qtyInput, delInput, couponInput].forEach(el => el.oninput = calculate);
